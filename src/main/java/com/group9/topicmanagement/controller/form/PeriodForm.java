...
public class PeriodForm {
    ...
    @DateTimeFormat(pattern = "yyyy-MM-dd'T'HH:mm") private LocalDateTime reportSubmissionDeadline;
    ...
    public LocalDateTime getReportSubmissionDeadline(){return reportSubmissionDeadline;} public void setReportSubmissionDeadline(LocalDateTime v){reportSubmissionDeadline=v;}
