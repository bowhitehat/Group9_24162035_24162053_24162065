...
public class SecurityConfig {
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/registrations").hasAnyRole("STUDENT", "FACULTY_MANAGER", "ADMIN")
                ...
                .requestMatchers("/reports/submit", "/reports/submit/**").hasRole("STUDENT")
                .requestMatchers("/reports/download/**", "/reports/history/**").authenticated()
                .requestMatchers("/reviewer-assignments/**", "/councils/**").hasAnyRole("FACULTY_MANAGER", "LECTURER")
                .requestMatchers("/evaluations/my-result").hasRole("STUDENT")
                .requestMatchers("/evaluations/**").hasAnyRole("FACULTY_MANAGER", "LECTURER")
