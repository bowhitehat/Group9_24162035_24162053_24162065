...
public class EvaluationController {
    ...
    public String showEvaluationForm(@PathVariable Long topicId,
        ...
        com.group9.topicmanagement.web.form.EvaluationSubmitDto form = new com.group9.topicmanagement.web.form.EvaluationSubmitDto();
    ...
    public String saveEvaluation(@PathVariable Long topicId,
                                 @jakarta.validation.Valid @org.springframework.web.bind.annotation.ModelAttribute("formDto") com.group9.topicmanagement.web.form.EvaluationSubmitDto formDto,
